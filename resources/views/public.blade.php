...
@section('content')
    ...
    <div class="featured-area bg-common-style" style="background-image: url('{{asset('student/img/featured/back.jpg')}}');">
        <div class="container">
    ...
    <div class="counter-area bg-primary-deep" style="background-image: url('{{asset('student/img/banner/4.jpg')}}');">
        <div class="container">
            <div class="row">
