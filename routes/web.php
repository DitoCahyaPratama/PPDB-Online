...
Route::get('/info', [App\Http\Controllers\InfoController::class, 'publicIndex'])->name('info');
Route::get('/info/detail/{slug}', [App\Http\Controllers\InfoController::class, 'publicDetail'])->name('info.details');
Route::get('/info/search', [App\Http\Controllers\InfoController::class, 'publicSearch'])->name('info.publicSearch');
